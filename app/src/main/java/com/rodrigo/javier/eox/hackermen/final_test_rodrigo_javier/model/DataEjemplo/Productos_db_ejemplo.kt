...
import com.rodrigo.javier.eox.hackermen.final_test_rodrigo_javier.model.room.entities.Productos_Entity
...
var producto_2 = Productos_Entity(
    1,
    /*el txt debe ser tratado para quedar en minúsculas al entrar a la db*/
    "poleras",
    5000
...
var producto_3 = Productos_Entity(
    2,
    /*el txt debe ser tratado para quedar en minúsculas al entrar a la db*/
    "zapatos",
    5000
...
var producto_4 = Productos_Entity(
    3,
    /*el txt debe ser tratado para quedar en minúsculas al entrar a la db*/
    "zapatillas",
    5000
...
var producto_5 = Productos_Entity(
    4,
    /*el txt debe ser tratado para quedar en minúsculas al entrar a la db*/
    "sombreros",
    5000
