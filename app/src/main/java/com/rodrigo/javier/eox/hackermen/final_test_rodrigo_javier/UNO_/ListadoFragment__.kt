...
import com.rodrigo.javier.eox.hackermen.final_test_rodrigo_javier.ui.ui_ventas_gastos.ventas.fragment_interiores.lista_inventario.Lista_Inventario_Adapter
...
class ListadoFragment__ : Fragment(), CardViewListenerShortClick, CardViewListenerLongClick {
...
//                this@ListadoFragment__,
    ...
    companion object {
        fun newInstance(): ListadoFragment__ {
            var newListado_Fragment = ListadoFragment__()
